...
public class WorkerDemo {
    public static void main(String[] args) {
        DailyWorker dailyWorker = new DailyWorker("John Doe", 150.0); // $150 per day
        SalariedWorker salariedWorker = new SalariedWorker("Jane Smith", 1200.0); // $1200 per week
        
        // Test with various work hours
